...
trivia_sheet_id = '1i3fdaZ8vORIv7EzRFMfmSrSxAOqeeBR5gBhl_7uOllE'
####################################################

def get_prizes():
    print(Fore.WHITE+'[ status ] Fetching Prizes')
    # get cells from the table within the winners sheet
    prise_table = rcdata.get_cells(trivia_sheet_id, 'J3:K6','RCL Trivia Winners')
...
def scan_sheet():
    ...
    trivia_sheet = rcdata.get_cells(trivia_sheet_id, 'B3:H','RCL Trivia Winners')
